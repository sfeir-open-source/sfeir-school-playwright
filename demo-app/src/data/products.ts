...
export const PRODUCTS: Product[] = [
  {
    ...
    img: '/assets/products/pain-aux-raisins.png',
    price: 1.5,
    quantity: 100,
    type: 'pastry',
  },
  ...
  },
  {
    ...
    img: '/assets/products/chausson-aux-pommes.png',
    price: 2.2,
    quantity: 70,
    type: 'pastry',
  },
  {
    label: { fr: 'Saint-Honoré', en: 'St. Honoré cake' },
    description: {
      fr: 'Pâte feuilletée, choux et crème chantilly',
      en: 'Puff pastry, choux and whipped cream',
    },
    img: '/assets/products/saint-honore.jpg',
    price: 5.5,
    quantity: 15,
    type: 'pastry',
  },
  {
    ...
    img: '/assets/products/pain-de-seigle.jpg',
    price: 2.9,
    quantity: 40,
    type: 'bread',
  },
  {
    ...
    img: '/assets/products/religieuse-cafe.jpg',
    price: 4.2,
    quantity: 30,
    type: 'pastry',
  },
  {
    ...
    img: '/assets/products/tarte-citron-meringue.jpg',
    price: 4.8,
    quantity: 25,
    type: 'pastry',
  },
  {
    ...
    img: '/assets/products/pain-aux-noix.jpg',
    price: 3.2,
    quantity: 35,
    type: 'bread',
  },
